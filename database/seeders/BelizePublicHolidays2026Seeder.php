...
{
    private const DEFAULT_PAY_MULTIPLIER = 1.5;

    private const DOUBLE_PAY_MULTIPLIER = 2.0;

    public function run(): void
    {
        $holidays = [
            ['date' => '2026-01-01', 'description' => "New Year's Day", 'payMultiplier' => self::DOUBLE_PAY_MULTIPLIER],
            ['date' => '2026-01-15', 'description' => 'George Price Day'],
            ['date' => '2026-03-09', 'description' => 'National Heroes and Benefactor Day'],
            ['date' => '2026-04-03', 'description' => 'Good Friday', 'payMultiplier' => self::DOUBLE_PAY_MULTIPLIER],
            ...
            ['date' => '2026-09-21', 'description' => 'Independence Day', 'payMultiplier' => self::DOUBLE_PAY_MULTIPLIER],
        ...
        foreach ($holidays as $holiday) {
            PublicHoliday::updateOrCreate(
                ['startDate' => $holiday['date'], 'name' => $holiday['description']],
                [
                    'endDate' => $holiday['date'],
                    'payMultiplier' => $holiday['payMultiplier'] ?? self::DEFAULT_PAY_MULTIPLIER,
                    'isActive' => true,
                ],
            );
        }
