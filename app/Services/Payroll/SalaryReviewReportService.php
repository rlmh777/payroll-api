    ...
    public function build(Carbon $startDate, Carbon $endDate): array
    {
        ...
        $aggregates = PayrollEarningLine::query()
            ...
            ->select([
                ...
                DB::raw("NULLIF(TRIM(CONCAT_WS(' ', employee.\"firstName\", employee.\"middleName\", employee.\"lastName\")), '') as employee_name"),
            ...
            ->groupBy(
                ...
                'payroll_earning_line.employeeId',
                DB::raw("NULLIF(TRIM(CONCAT_WS(' ', employee.\"firstName\", employee.\"middleName\", employee.\"lastName\")), '')"),
                'employee.code',
                'employee.lastName',
                'employee.firstName',
                'payroll_earning_line.accountId',
