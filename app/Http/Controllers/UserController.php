...
class UserController extends Controller
{
    public function __construct(
        ...
        private readonly UserRoleAssignmentService $userRoleAssignment,
    ) {
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        if ($request->has('roles')) {
            $this->userRoleAssignment->attach($user, $request->input('roles', []));
        }
    ...
    public function update(Request $request, User $user)
    {
        ...
        if ($request->has('roles')) {
            $this->userRoleAssignment->sync($user, $request->input('roles', []));
        }
    ...
    public function removeRoles(Request $request, User $user)
    {
        ...
        $this->userRoleAssignment->detach($user, $request->input('roles', []));
    ...
    public function removeAllRoles(Request $request, User $user)
    {
        ...
        $this->userRoleAssignment->sync($user, []);
