...
return [
    ...
    */
    'resources' => [
        ...
        'pipeline-templates' => ['view' => 'view-pipeline-templates', 'write' => 'pipeline-templates-crud'],
        ...
        'scheduler-daily-metrics' => ['view' => 'view-calendars', 'write' => 'scheduler-daily-metrics-crud'],
        'scheduler-events' => ['view' => 'view-calendars', 'write' => 'calendar-crud'],
        'scheduler-metric-definitions' => ['view' => 'view-scheduler-metrics', 'write' => 'scheduler-metrics-crud'],
        'scheduler-notices' => ['view' => 'view-calendars', 'write' => 'calendar-crud'],
        'shift-templates' => ['view' => 'view-calendars', 'write' => 'calendar-crud'],
    ...
    */
    'overrides' => [
        ...
        'POST employees/hours-bank/balances' => 'view-employees',
        ...
        'GET users' => ['manager-users', 'reset-subordinate-passwords'],
        'GET users/{user}' => ['manager-users', 'reset-subordinate-passwords'],
        'PUT users/{user}/password' => ['manager-users', 'reset-subordinate-passwords'],
        'POST users/{user}/send-password-reset' => ['manager-users', 'reset-subordinate-passwords'],
